<template>
  <div class="w-full bg-gradient-to-br from-stone-50 to-stone-100">
    <!-- If expanded: show hero style header -->
    <section
      v-if="props.expanded"
      class="bg-stone-100 border-b border-stone-200 py-12"
    >
      <div class="container mx-auto max-w-5xl px-4 text-center space-y-6">
        <h1 class="text-4xl md:text-6xl font-bold text-stone-800">
          Parish Timeline
        </h1>
        <svg
          class="w-28 h-auto mx-auto text-amber-600"
          viewBox="0 0 100 12"
          fill="none"
        >
          <path
            d="M0 5 H50 C75 5 75 0 100 5"
            stroke="currentColor"
            stroke-width="2"
          />
        </svg>
        <p class="text-lg md:text-xl text-stone-600 max-w-2xl mx-auto">
          Discover the milestones and blessings that led to the founding of our Orthodox Old Rite Mission.
        </p>
      </div>
    </section>

    <!-- If not expanded: classic section header -->
    <div v-else class="flex flex-col items-center text-center gap-6 py-16">
      <h2
        class="text-4xl md:text-5xl text-stone-800 font-bold leading-tight tracking-tight"
      >
        Our Journey
      </h2>
      ...
      <p
        class="text-lg md:text-2xl text-stone-600 leading-relaxed max-w-3xl px-4"
      >
        ...
        <div class="space-y-8 md:space-y-2 relative z-10">
          ...
          >
            ...
            <div class="md:hidden flex items-center w-full">
              <!-- Dot -->
              <div
                class="flex-shrink-0 flex flex-col items-center mr-6 relative z-10"
              >
                <div
            ...
            <div class="hidden md:flex items-center w-full">
              ...
              <div v-if="index % 2 === 0" class="flex items-center w-full">
                ...
                <div
                  class="flex-shrink-0 flex flex-col items-center relative z-10"
                >
                  <div
                    class="w-6 h-6 bg-gradient-to-br from-amber-500 to-amber-600 rounded-full shadow-lg border-4 border-white"
                  ></div>
